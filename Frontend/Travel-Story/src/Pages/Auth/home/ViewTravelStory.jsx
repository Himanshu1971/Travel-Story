...
export default function ViewTravelStory({storyInfo,onClose,onEditClick,onDeleteClick}) {
  return (
    <div className='relative'>
        <div className='flex items-center justify-end'>
            <div>
                <div className='flex items-center gap-3 bg-cyan50/50 p-2 rounded-l-lg'>
      ...
      <img 
        ...
        <div className='mt-4'>
            <p className='text-md text-slate-950 leading-6 text-justify whitespace-pre-line'>{storyInfo.story}</p>
        </div>
    </div>
  )
}
